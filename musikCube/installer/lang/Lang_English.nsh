...
#____ Install Options
  ...
  LangString IO_Header ${LANG_ENGLISH} "Choose Additional Tasks"
  LangString IO_SubHeader ${LANG_ENGLISH} "Choose additional tasks which should be executed during installation."
  LangString IO_DeskIcon ${LANG_ENGLISH} "Desktop icon"
  LangString IO_QLIcon ${LANG_ENGLISH} "Quick Launch icon"
  LangString IO_Associate ${LANG_ENGLISH} "Associate musikCube with"
  LangString IO_Shortcuts ${LANG_ENGLISH} "Create shortcuts"
...
#____ Message Boxes
  ...
  LangString MB_AlreadyInstalled ${LANG_ENGLISH} "An older version of ${PRODUCT_NAME} is already installed.$\n$\n\
