...
#____ Includes
  ...
  !include "header\musikCubePlugins.nsh"
 
#____ Definitions

  #!define MC_FONT_NAME "Musik (TrueType)"
  #!define MC_FONT_FILE "musikCube.ttf"
  ...
  !define MC_EXT_MP3 ".mp3"
  !define MC_EXT_OGG ".ogg"
  !define MC_EXT_APE ".ape"
  !define MC_EXT_FLAC ".flac"
  !define MC_EXT_M4A ".m4a"
  !define MC_EXT_MOD ".mod"
  !define MC_EXT_WAV ".wav"
  !define MC_EXT_WMA ".wma"
  !define MC_EXT_MPC ".mpc"
  !define MC_EXT_WV ".wv"

  !define MC_FC_MP3 "musikCube.MP3File"
  !define MC_FC_OGG "musikCube.OGGFile"
  !define MC_FC_APE "musikCube.APEFile"
  !define MC_FC_FLAC "musikCube.FLACFile"
  !define MC_FC_M4A "musikCube.M4AFile"
  !define MC_FC_MOD "musikCube.MODFile"
  !define MC_FC_WAV "musikCube.WAVFile"
  !define MC_FC_WMA "musikCube.WMAFile"
  !define MC_FC_MPC "musikCube.MPCFile"
  !define MC_FC_WV "musikCube.WVFile"

  !define MC_FILE_NAME "musikCube Media File"
  !define MC_BACKUP "musikCube_Back"
  !define MC_ICON_LIB "icons.icl"
...
#____ Functions
  ...
  Function AssociateExt
    ...
    ; Make sure, icon library exists
    ${Unless} ${FileExists} "$INSTDIR\${MC_ICON_LIB}"
      SetOutPath "$INSTDIR"
      File /oname=${MC_ICON_LIB} "res\${MC_ICON_LIB}"
    ${EndUnless}
