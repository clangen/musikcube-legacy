/*
 * This was originally part of TagLib. It was modified
 * to function as part of musikCore.
 *
 *  - Casey Langen
 *
*/
...
namespace musikUnicode {

UNICODE_EXPORT typedef unsigned long	UTF32;	/* at least 32 bits */
UNICODE_EXPORT typedef unsigned short	UTF16;	/* at least 16 bits */
UNICODE_EXPORT typedef unsigned char	UTF8;	/* typically 8 bits */
UNICODE_EXPORT typedef unsigned char	Boolean; /* 0 or 1 */

UNICODE_EXPORT typedef enum {
...
UNICODE_EXPORT ConversionResult ConvertUTF8toUTF16 (
		const UTF8** sourceStart, const UTF8* sourceEnd, 
		UTF16** targetStart, UTF16* targetEnd, ConversionFlags flags);

UNICODE_EXPORT ConversionResult ConvertUTF16toUTF8 (
		const UTF16** sourceStart, const UTF16* sourceEnd, 
		UTF8** targetStart, UTF8* targetEnd, ConversionFlags flags);
		
UNICODE_EXPORT Boolean isLegalUTF8Sequence(const UTF8 *source, const UTF8 *sourceEnd);
