...
//	REVISION HISTORY
//
//    2004-JUN-19 - MinGW compatibility, as well as an MFC compile fix for
//                  the overloaded bitshift operator (<<) and wide strings.
//                  (Casey Langen)
//
...
// -----------------------------------------------------------------------------
#if defined(SS_ANSI) || !defined(_MSC_VER) && !defined(__MINGW32__)
