/* BASSCD 2.2 C/C++ header file, copyright (c) 2003-2005 Ian Luck.
...
char *BASSCDDEF(BASS_CD_GetDriveDescription)(DWORD drive);
DWORD BASSCDDEF(BASS_CD_GetDriveLetter)(DWORD drive);
...
DWORD BASSCDDEF(BASS_CD_Analog_PlayFile)(char *file, DWORD pos);
